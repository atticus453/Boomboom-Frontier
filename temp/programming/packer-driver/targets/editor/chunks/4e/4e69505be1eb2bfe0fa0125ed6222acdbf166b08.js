System.register(["__unresolved_0", "@firebase/util", "tslib", "@firebase/component", "@firebase/app", "@firebase/logger"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      _req = _firebaseUtil.__cjsMetaURL;
    }, function (_tslib) {
      _req0 = _tslib.__cjsMetaURL;
    }, function (_firebaseComponent) {
      _req1 = _firebaseComponent.__cjsMetaURL;
    }, function (_firebaseApp) {
      _req2 = _firebaseApp.__cjsMetaURL;
    }, function (_firebaseLogger) {
      _req3 = _firebaseLogger.__cjsMetaURL;
    }],
    execute: function () {
      ...
      _cjsLoader.define(__cjsMetaURL, function (exports, require, module, __filename, __dirname) {
        ...
        /* AppError.NO_APP */
        ] = "No Firebase App '{$appName}' has been created - " + 'call Firebase App.initializeApp()', _a["invalid-app-argument"
        ...
        function createFirebaseNamespaceCore(firebaseAppImpl) {
          ...
          function registerComponentCompat(component) {
            ...
            if (modularAPIs__namespace._registerComponent(component) && component.type === "PUBLIC"
            /* ComponentType.PUBLIC */
            ) {
        ...
        module.exports = firebase; // #endregion ORIGINAL CODE

        _export("default", _cjsExports = module.exports);
      }, () => ({
        '@firebase/util': _req,
        'tslib': _req0,
        '@firebase/component': _req1,
        '@firebase/app': _req2,
        '@firebase/logger': _req3
      }));
    }
  };
});
//# sourceMappingURL=4e69505be1eb2bfe0fa0125ed6222acdbf166b08.js.map