System.register(["__unresolved_0", "@firebase/component", "tslib", "@firebase/logger", "@firebase/util", "idb"], function (_export, _context) {
  ...
  return {
    ...
    }, function (_firebaseComponent) {
      _req = _firebaseComponent.__cjsMetaURL;
    }, function (_tslib) {
      _req0 = _tslib.__cjsMetaURL;
    }, function (_firebaseLogger) {
      _req1 = _firebaseLogger.__cjsMetaURL;
    }, function (_firebaseUtil) {
      _req2 = _firebaseUtil.__cjsMetaURL;
    }, function (_idb) {
      _req3 = _idb.__cjsMetaURL;
    }],
    execute: function () {
      ...
      _cjsLoader.define(__cjsMetaURL, function (exports, require, module, __filename, __dirname) {
        ...
        var PLATFORM_LOG_STRING = (_a$1 = {}, _a$1[name$p] = 'fire-core', _a$1[name$o] = 'fire-core-compat', _a$1[name$m] = 'fire-analytics', _a$1[name$n] = 'fire-analytics-compat', _a$1[name$k] = 'fire-app-check', _a$1[name$l] = 'fire-app-check-compat', _a$1[name$j] = 'fire-auth', _a$1[name$i] = 'fire-auth-compat', _a$1[name$h] = 'fire-rtdb', _a$1[name$g] = 'fire-rtdb-compat', _a$1[name$f] = 'fire-fn', _a$1[name$e] = 'fire-fn-compat', _a$1[name$d] = 'fire-iid', _a$1[name$c] = 'fire-iid-compat', _a$1[name$b] = 'fire-fcm', _a$1[name$a] = 'fire-fcm-compat', _a$1[name$9] = 'fire-perf', _a$1[name$8] = 'fire-perf-compat', _a$1[name$7] = 'fire-rc', _a$1[name$6] = 'fire-rc-compat', _a$1[name$5] = 'fire-gcs', _a$1[name$4] = 'fire-gcs-compat', _a$1[name$3] = 'fire-fst', _a$1[name$1] = 'fire-fst-compat', _a$1[name$2] = 'fire-vertex', _a$1['fire-js'] = 'fire-js', _a$1[name] = 'fire-js-all', _a$1);
        /**
         * @license
         * Copyright 2019 Google LLC
         *
        ...
        /* AppError.NO_APP */
        ] = "No Firebase App '{$appName}' has been created - " + 'call initializeApp() first', _a["bad-app-name"
        /* AppError.BAD_APP_NAME */
        ] = "Illegal App name: '{$appName}'", _a["duplicate-app"
        /* AppError.DUPLICATE_APP */
        ] = "Firebase App named '{$appName}' already exists with different options or config", _a["app-deleted"
        /* AppError.APP_DELETED */
        ] = "Firebase App named '{$appName}' already deleted", _a["server-app-deleted"
        /* AppError.SERVER_APP_DELETED */
        ] = 'Firebase Server App has been deleted', _a["no-options"
        /* AppError.NO_OPTIONS */
        ] = 'Need to provide options, when not being deployed to hosting via source.', _a["invalid-app-argument"
        /* AppError.INVALID_APP_ARGUMENT */
        ] = 'firebase.{$appName}() takes either no argument or a ' + 'Firebase App instance.', _a["invalid-log-argument"
        /* AppError.INVALID_LOG_ARGUMENT */
        ] = 'First argument to `onLog` must be null or a function.', _a["idb-open"
        /* AppError.IDB_OPEN */
        ] = 'Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.', _a["idb-get"
        /* AppError.IDB_GET */
        ] = 'Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.', _a["idb-set"
        /* AppError.IDB_WRITE */
        ] = 'Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.', _a["idb-delete"
        /* AppError.IDB_DELETE */
        ] = 'Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}.', _a["finalization-registry-not-supported"
        /* AppError.FINALIZATION_REGISTRY_NOT_SUPPORTED */
        ] = 'FirebaseServerApp deleteOnDeref field defined but the JS runtime does not support FinalizationRegistry.', _a["invalid-server-app-environment"
        ...
        function (_super) {
          ...
          function FirebaseServerAppImpl(options, serverConfig, name, container) {
            var _this = this; // Build configuration parameters for the FirebaseAppImpl base class.
            ...
            _this._serverConfig = tslib.__assign({
              automaticDataCollectionEnabled: automaticDataCollectionEnabled
            }, serverConfig);
            ...
            _this.incRefCount(_this._serverConfig.releaseOnDeref); // Do not retain a hard reference to the dref object, otherwise the FinalizationRegisry
            // will never trigger.
        ...
        function initializeServerApp(_options, _serverAppConfig) {
          ...
          var nameObj = tslib.__assign(tslib.__assign({}, _serverAppConfig), appOptions); // However, Do not mangle the name based on releaseOnDeref, since it will vary between the
          ...
          return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  result = _a.sent(); // We already have the value but tx.done can throw,
              ...
              return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                  case 0:
                    ...
                    if (!(((_a = this._heartbeatsCache) === null || _a === void 0 ? void 0 : _a.heartbeats) == null)) return [3
                    /*break*/
                    , 2];
                    _c = this;
                    return [4
                  ...
                  case 1:
                    _c._heartbeatsCache = _d.sent(); // If we failed to construct a heartbeats cache, then return immediately.
          ...
          HeartbeatServiceImpl.prototype.getHeartbeatsHeader = function () {
            ...
            return tslib.__awaiter(this, void 0, void 0, function () {
              ...
              return tslib.__generator(this, function (_c) {
                switch (_c.label) {
                  case 0:
                    if (!(this._heartbeatsCache === null)) return [3
                    /*break*/
                    , 2];
                    return [4
                    /*yield*/
                  ...
                  case 2:
                    ...
                    if (!(unsentEntries.length > 0)) return [3
                    /*break*/
                    , 4]; // Store any unsent entries if they exist.
            ...
            return tslib.__awaiter(this, void 0, void 0, function () {
              return tslib.__generator(this, function (_a) {
                if (!util.isIndexedDBAvailable()) {
                  ...
                  return [2
                  /*return*/
                  , util.validateIndexedDBOpenable().then(function () {
                    return true;
                  }).catch(function () {
                    return false;
                  })];
        ...
        function registerCoreComponents(variant) {
          ...
          registerVersion(name$p, version$1, 'cjs5'); // Register platform SDK identifier (no version).
        ...
        exports.setLogLevel = setLogLevel; // #endregion ORIGINAL CODE
...
//# sourceMappingURL=90997eabe8ce7836b94622394cb7406ec179e3ae.js.map